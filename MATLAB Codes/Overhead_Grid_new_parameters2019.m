open_system('Desktop\\Thesis\Thesis_Grid_2_2019.slx');
tic
BlockPaths = find_system('Thesis_Grid_2_2019','Type','Block');
close all
...
Data = cell(2500,35);
Lengths = [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200];
GridRs =[];
GridLs = [];
GridRp = [];
GridCp = [];
...
% end
writetable(cell2table(Data), '60hz1000ohmsnofault5.csv', 'writevariablenames', false)
